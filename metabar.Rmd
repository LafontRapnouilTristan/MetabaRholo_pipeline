...
metablists[[folder_names[1]]]$samples %<>% 
  mutate(organ = ifelse( grepl("(_Rp)|([0-9]{3}R)",metablists[[folder_names[1]]]$samples$samples)==T,"ROOTS",
                         ifelse( grepl("FL",metablists[[folder_names[1]]]$samples$samples)==T,"FLOWER",
                                 ifelse( grepl("FE",metablists[[folder_names[1]]]$samples$samples)==T,"LEAVES",
                                         ifelse( grepl("FR",metablists[[folder_names[1]]]$samples$samples)==T,"FRUIT",
                                                 ifelse( grepl("RJ",metablists[[folder_names[1]]]$samples$samples)==T,"RESHOOT",
                                                         ifelse( grepl("GR",metablists[[folder_names[1]]]$samples$samples)==T,"SEEDS",
                                                                 ifelse( grepl("ED",metablists[[folder_names[1]]]$samples$samples)==T,"ENDOPHYTES",
                                                                         ifelse( grepl("EP",metablists[[folder_names[1]]]$samples$samples)==T,"EPIPHYTES",
                                                                                 ifelse( grepl("[0-9]{3}(S|C)",metablists[[folder_names[1]]]$samples$samples)==T,"RHIZOSPHERE",
                                                                                         ifelse( grepl("CT|EXT|PCR|TPOS",metablists[[folder_names[1]]]$samples$samples)==T,"CONTROL","SOIL")
                                                                                 ))))))))))

metablists[[folder_names[2]]]$samples %<>% 
  mutate(organ = ifelse( grepl("_R|(-R)|([0-9]{3}R)",metablists[[folder_names[2]]]$samples$samples)==T,"ROOTS",
                         ifelse( grepl("FL",metablists[[folder_names[2]]]$samples$samples)==T,"FLOWER",
                                 ifelse( grepl("FE",metablists[[folder_names[2]]]$samples$samples)==T,"LEAVES",
                                         ifelse( grepl("FR",metablists[[folder_names[2]]]$samples$samples)==T,"FRUIT",
                                                 ifelse( grepl("RJ",metablists[[folder_names[2]]]$samples$samples)==T,"RESHOOT",
                                                         ifelse( grepl("GR",metablists[[folder_names[2]]]$samples$samples)==T,"SEEDS",
                                                                 ifelse( grepl("ED",metablists[[folder_names[2]]]$samples$samples)==T,"ENDOPHYTES",
                                                                         ifelse( grepl("EP",metablists[[folder_names[2]]]$samples$samples)==T,"EPIPHYTES",
                                                                                 ifelse( grepl("[0-9]{3}(S|C)",metablists[[folder_names[2]]]$samples$samples)==T,"RHIZOSPHERE",
                                                                                         ifelse( grepl("CT|EXT|PCR|TPOS",metablists[[folder_names[2]]]$samples$samples)==T,"CONTROL","SOIL")
                                                                                 ))))))))))

metablists[[folder_names[4]]]$samples %<>% 
  mutate(organ= ifelse(grepl("_F",metablists[[folder_names[4]]]$samples$samples)==T,"LEAVES",
                       ifelse(grepl("_R",metablists[[folder_names[4]]]$samples$samples)==T,"ROOTS","CONTROL")))


metablists[[folder_names[3]]]$samples %<>% 
  mutate(organ = ifelse( grepl("_R|(-R)|([0-9]{3}R)",metablists[[folder_names[3]]]$samples$samples)==T,"ROOTS",
                         ifelse( grepl("FL",metablists[[folder_names[3]]]$samples$samples)==T,"FLOWER",
                                 ifelse( grepl("FE",metablists[[folder_names[3]]]$samples$samples)==T,"LEAVES",
                                         ifelse( grepl("FR",metablists[[folder_names[3]]]$samples$samples)==T,"FRUIT",
                                                 ifelse( grepl("RJ",metablists[[folder_names[3]]]$samples$samples)==T,"RESHOOT",
                                                         ifelse( grepl("GR",metablists[[folder_names[3]]]$samples$samples)==T,"SEEDS",
                                                                 ifelse( grepl("ED",metablists[[folder_names[3]]]$samples$samples)==T,"ENDOPHYTES",
                                                                         ifelse( grepl("EP",metablists[[folder_names[3]]]$samples$samples)==T,"EPIPHYTES",
                                                                                 ifelse( grepl("[0-9]{3}(S|C)",metablists[[folder_names[3]]]$samples$samples)==T,"RHIZOSPHERE",
                                                                                         ifelse( grepl("CT|EXT|PCR|TPOS",metablists[[folder_names[3]]]$samples$samples)==T,"CONTROL","SOIL")
                                                                                 ))))))))))

metablists[[folder_names[5]]]$samples %<>%
  mutate(organ= ifelse(grepl("_F",metablists[[folder_names[5]]]$samples$samples)==T,"LEAVES",
                       ifelse(grepl("_R",metablists[[folder_names[5]]]$samples$samples)==T,"ROOTS","CONTROL")))
...
for (i in 1:length(folder_names)){
  ...
  target_kingdom <- ifelse(target=="16s","Bacteria","Fungi") # what do we target
