...
ggsave("figures/reads_and_motus.jpg",diagplot )
```
...
ggsave("figures/motu_read_cor.jpg",moturead )
```
...
contaprop <- ggarrange(plotlist =  conta_prop, ncol = 2,nrow = length(folder_names)/2, common.legend = T , legend ="bottom")
contaprop
```
...
plottaxboots <- ggarrange(plotlist =  plot_tax_boots, ncol = 2,nrow = length(folder_names)/2, common.legend = T , legend ="bottom")
plottaxboots
```
...
plotseqdepth <- ggarrange(plotlist =  plot_seq_depth, ncol = 2,nrow = length(folder_names)/2)
plotseqdepth
```
...
plottagjump <- ggarrange(plotlist =  plot_tag_jump, ncol = 2,nrow = length(folder_names)/2)
plottagjump
```
...
plotnoisemotu <- ggarrange(plotlist =  plot_noise_motu, ncol = 2,nrow = length(folder_names)/2,common.legend = T, legend = "bottom")
plotnoisemotu
```
...
plotnoisepcr <- ggarrange(plotlist =  plot_noise_pcr, ncol = 2,nrow = length(folder_names)/2,common.legend = T, legend = "bottom")
plotnoisepcr
```
...
sumpipelineplots <- ggarrange(plotlist =  sumpipeline_plots, ncol = 2,nrow = length(folder_names)/2,common.legend = T, legend = "bottom")
sumpipelineplots
```
...
betadiv <- ggarrange(plotlist =  beta_div, ncol = 2,nrow = length(folder_names)/2,common.legend = T, legend = "bottom")
betadiv
```
