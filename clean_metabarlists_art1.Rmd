...
folder_names <- folder_names[-c(3:5)]
...
```{r}
ggsave("figures/motu_read_cor_art1.jpg",moturead, height = 4, width = 6 )
```
...
```{r}
ggsave("figures/conta_prop_art1.jpg",contaprop, height = 4, width = 6 )
```
...
```{r}
ggsave("figures/tax_boots_art1.jpg",plottaxboots, height = 4, width = 6 )
```
...
```{r}
ggsave("figures/seq_depth_art1.jpg",plotseqdepth, height = 4, width = 6 )
```
...
ggsave("figures/tag_jump_art1.jpg",plottagjump, height = 8, width = 13 )
```
...
ggsave("figures/noise_motu_art1.jpg",plotnoisemotu, height = 5, width = 8 )
```
...
ggsave("figures/noise_pcr_art1.jpg",plotnoisepcr, height = 5, width = 8)
```
...
ggsave("figures/sum_pipeline_art1.jpg",sumpipelineplots, height = 3, width = 6)
```
...
ggsave("figures/motu_read_cor_post_art1.jpg",moturead, height = 4, width = 6 )
```
...
ggsave("figures/tax_boots_post_art1.jpg",plottaxbootspost, height = 4, width = 6 )
```
...
ggsave("figures/betadiv_art1.jpg",betadiv, height = 12, width = 40 )
```
...
ggsave("figures/betadiv2_art1.jpg",betadiv2, height = 12, width = 40 )
```
