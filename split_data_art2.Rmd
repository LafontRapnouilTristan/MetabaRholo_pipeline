...
# 
# sub_mother_16s <- subset_samples(physeqlists$mother_16s2, (organ == "LEAVES" | organ == "ROOTS") & project == "HOLOBROM_SEEDLING")
...
```{r}
save(list=c("seedling_16s","seedling_ITS"), file = "data/out/seedling_leafNroot.RData")
```
