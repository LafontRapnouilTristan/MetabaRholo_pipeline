...
ggsave("figures/seq_reads_pct_loss_art2.png",plot_smry, height = 5,width = 6)

plot_smpl <- ggarrange(plotlist = plot_sample_smry, ncol = 2, nrow = length(plot_glob_smry)/2, common.legend = T, legend = "bottom")
ggsave("figures/smpl_track_art2.png",plot_smpl, height = 5,width = 6)
```
